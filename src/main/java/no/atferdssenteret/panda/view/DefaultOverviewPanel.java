...
public class DefaultOverviewPanel extends JPanel implements Observer {
    private static final long serialVersionUID = 1L;

    private AbstractOverviewController controller;
...
//    private AbstractOverviewTableModel tableModel;
    ...
    public DefaultOverviewPanel(AbstractOverviewController controller, FilterCreator filterCreator) {
