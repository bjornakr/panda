...
public class QuestionnairesAndDataCollectionsSetup {
	...
	private static final String Q_PARENT = "Foreldreskjema 2";
	private static final String Q_TEACHER = "Lærerskjema 2";
	private static final String Q_INTERVENTIONIST_PROCESS = "Prosess, intervensjonist 2";
	private static final String Q_TEACHER_PROCESS = "Prosess, lærer 2";
