...
public class YouthDialog extends JDialog implements TargetDialog {
	...
	private JLabel labId = new JLabel(" ");
	...
	private JComboBox cboxDataCollectorsTelephone = new JComboBox(User.dataCollectors().toArray());
...
//		add(labId, c);
		...
		labId.setFont(GuiUtil.HEADER_FONT_SECONDARY);
		labelsAndFields.add(new LabelFieldPair(new JLabel("ID"), labId));
		...
		cboxDataCollectorsTelephone.insertItemAt(null, 0);
		cboxDataCollectorsTelephone.setSelectedIndex(0);
		labelsAndFields.add(new LabelFieldPair(new JLabel("Telefonintervjuer"), cboxDataCollectorsTelephone));
	...
	public void restrictAccess() {
		...
		cboxDataCollectorsTelephone.setEnabled(false);
	...
	public Object getDataCollectorTelephone() {
		return cboxDataCollectorsTelephone.getSelectedItem();
	}
	...
	public void setDataCollectorTelephone(User dataCollectorTelephone) {
		cboxDataCollectorsTelephone.setSelectedItem(dataCollectorTelephone);
	}
